 ...
 * @since  4.0.0
 */
class NewMVCFactory implements MVCFactoryInterface, FormFactoryAwareInterface
{
	 ...
	 * @since   4.0.0
	 */
	public function __construct($namespace, CMSApplicationInterface $application, DatabaseDriver $db)
	{
